...
GTAPAEZ_path <- file.path(parent_folder, "2_Model_R1/")
...
# Import the data
data_qo <- read_excel(paste0(external_data_path, "/qo_values_R1.xlsx"))
data_tmsf <- read_excel(paste0(external_data_path, "/tms_f_initial_shocks_R1.xlsx"))
data_qxw <- read_excel(paste0(external_data_path, "/qxw_values_R1.xlsx"))
...
process_sheet <- function(sheet_name) {
  # Import the data
  data <- read_excel(paste0(external_data_path, "/qes_values_R1.xlsx"), sheet = sheet_name, col_names = TRUE, col_types = NULL, na = "", skip = 0)
...
original_ev_new <- read_excel(paste0(external_data_path,"/Original_EV_R1.xlsx"),sheet=1,col_names= FALSE,col_types=NULL,na="",skip= 0)
...
source_folder_copy <- file.path(parent_folder, "2_Model_R1", "BU/")
...
thresholds <- read_excel(paste0(external_data_path,"/",approach,"/Thresholds_GTAPAEZ_Game_theory_R1.xlsx"),sheet=2,col_names= FALSE,col_types=NULL,na="",skip= 0)
...
# Write the vector to a file. Include the iteration number in the file name.
  ...
  source_tracker <- file.path(parent_folder, "2_Model_R1", sl4)
